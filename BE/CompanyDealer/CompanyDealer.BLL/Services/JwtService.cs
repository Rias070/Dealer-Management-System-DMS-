using CompanyDealer.DAL.Repository.TokenRepo;
...
namespace CompanyDealer.BLL.Services
{
    public class JwtService
    {
        ...
        public JwtService(IConfiguration configuration, ITokenRepository tokenRepository, IAccountRepository userRepository)
        {
